...
class City extends Component {
   ...
   searchHandler = () => {
     this.setState({reastaurants: null})
   ...
   getCategories = () => {
     ...
     .then(({ data }) => {
      const categories = this.transformCategoriesData(data.categories)
      ...
      componentDidMount() {
       ...
       return (
          ...
          <RestaurantCard key={restaurant.id} restaurant={restaurant} />
           ...
           return(
          <div className = 'col'>
            <p>Tidak ada data yang tersedia. Silakan pilih kriteria, dan klik Cari</p>
          </div>
           )
        }
    }
    ...
    render () {
        return (
            ...
            {this.state.city && (
                <div className='row'>
                <div className='col'>
                    <h4 className='text-success'>Restoran di {this.state.city.name}, "{this.state.city.country_name}"</h4>
                </div>
            </div>
            )}
            <div className='row'>
                ...
                SearchRestoran={this.state.keyword}
              ...
              />
                ...
                <div className='row'>
                  <div className='col' style={{marginBottom: 10}}>
                    <h4 className='text-success'>Daftar Restoran</h4>
                  </div>
                </div>
                <div className='row'>
